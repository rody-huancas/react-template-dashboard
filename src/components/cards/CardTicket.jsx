...
export const CardTicket = ({ ticket, totalTickets, text }) => {
  let status = "";
  let textColor = "";
    ...
    <div className="bg-secondary-100 p-8 rounded-xl">
      <div className="flex items-center justify-between mb-4">
        ...
        <div>
          <Menu
            menuButton={
              <MenuButton className="flex items-center gap-x-2 hover:bg-secondary-900 p-2 rounded-lg transition-colors duration-300">
                <RiMore2Fill />
              </MenuButton>
            }
            align={"end"}
